...
function ShippingAddress() {
    ...
    const payCash = async (values) => {
        ...
        setisloading(true)
        const result = await axios.post(`https://ecommerce.routemisr.com/api/v1/orders/checkout-session/${cartId}?url=https://thoriamaaly.github.io`, { shippingAddress: values }, {
            headers: {
